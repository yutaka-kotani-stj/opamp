...
![short_channel](01_short_channel.png)

基準電流源の10uAをカレントミラー回路でコピーした場合、出力電流は次のようになりました。

| チャネル長L  | チャネル幅W |　出力電流(5V時)|誤差|
| ------------ | ----------- | -------------- | -- |
| 1um | 10um | 11.749uA | 16.08% |
| 2um | 20um | 10.856uA | 8.209% |
| 3um | 30um | 10.615uA | 5.967% |
| 4um | 40um | 10.485uA | 4.735% |
